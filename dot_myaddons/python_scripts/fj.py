...
def main():
    ...
    output_parts.append("# After I tell you what to change, generate ONLY the ap patch file.\n")
    output_parts.append("# Nothing else. Just the patch.\n")
    ...
    output_parts.append("\n\n# === GIT COMMANDS ===\n")
    output_parts.append("#\n")
    output_parts.append("# After applying the patch, you can commit the changes:\n")
    output_parts.append("#\n")
    output_parts.append("```bash\n")
    output_parts.append("git add .\n")
    output_parts.append('git commit -m "<type>(<scope>): <description>"\n')
    output_parts.append("```\n")
    output_parts.append("#\n")
